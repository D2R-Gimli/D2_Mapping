---Base Area----------------------------
Act5 - Halls of Anguish
Act5 - Halls of Pain
Act5 - Halls of Vaught
...
---DT1 files used:----------------------
Expansion/wildtemple/interior.dt1	<-- THIS SHOULD BE REPLACED BY MY EDITED FILE ==> (PD2assets/torturehalls/interior.dt1)
!! for testing it is possible to replace the wildtemple/interior with my file !!


Expansion/town/trees.dt1 			<-- Original file
PD2assets/torturehalls/a5_torture.dt1	<-- Repaletted one
PD2assets/torturehalls/torturehalls.dt1	<-- New file made by me

I've made a subfolder in PD2assets to keep it clean, since there are already alot of files in there.
So it will be more clear which files are used for which map.
----------------------------------------


---Map goals:---------------------------
- A red/bloody boss (which should fit the theme of the map)
- Set evil urns in the side areas (maybe 1-3 can be set randomly in the map by txt files)
- Wirts Body to grab a leg (if this does not cause server crash -> needs to be tested)
- A set superchest (highlighted in the map)
- A "straight route" - meaning no back and forth playstyle. If you run the map on one direction you should get to the end without missing some areas.
- Monstertypes / Density needs to be done and fine tuned
----------------------------------------
